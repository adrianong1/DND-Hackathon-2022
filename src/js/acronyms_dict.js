const ENGLISH_ACRONYMS = {
	...
	"AOR": ["area of responsibility", "oiler replenishment"],
	...
	"CDA": ["Canadian Defence Attaché", "Canadian Defence Academy"],
	...
	"CM": ["career manager", "countermeasure", "Member of the Order of Canada"],
	...
	"DSST": ["deployed signals intelligence support team", "deployed SIGINT support team"],
	...
	"EO": ["electro-optics", "enabling objective"],
	...
	"FC": ["fighter controller", "fire chief"],
	...
	"GSM": ["government supplied materiel", "Group Sergeant-Major"],
	...
	"IMS": ["international military staff", "International Military Staff", "information management standard"],
	"IM standard": ["information management standard"],
	"IMTP": ["Information Management Terminology Panel"],
	"incl": ["include", "included", "inclure", "inclus", "inclusif", "inclusion", "inclusive", "inclusively", "inclusivement"],
	...
	"IP": ["incentive pay", "intellectual property"],
	...
	"LCC": ["Learning and Career Centre", "logistics coordination centre"],
	...
	"LOC": ["lines of communications", "logistics operations centre"],
	...
	"NLO": ["naval liaison officer", "nursing liaison officer"],
	"NLT": ["not later than"],
	...
	"NOS": ["network operating system", "network operations and security"],
	"Nov": ["November"],
	...
	"off": ["offence", "offense", "offensif", "offensive"],
	...
	"OPI": ["obus ermanents incendiaire", "office of primary interest"],
	...
	"PCRA": ["post-combat reintegration allowance", "Project Complexity and Risk Assessment"],
	...
	"PI": ["photographic interpretation", "point initial"],
	...
	"PSO": ["Primary Standardization Office", "peace support operation", "personnel selection officer"],
	...
	"RT": ["radio-telephony", "radius of target"],
	...
	"SO": ["semi-officiel", "staff officer"],
	...
	"SOR": ["statement of ordinary residence", "statement of requirement"],
	...
	"SSN": ["nuclear attack submarine", "nuclear-powered attack submarine"],
...
const FRENCH_ACRONYMS = {
	...
	"13 Pon PM": ["13e Peloton de police militaire"],
	"15 Pon PM": ["15e Peloton de police militaire"],
	...
	"31 Pon PM": ["31e Peleton de police militaire"],
	...
	"AN": ["Autorité de navigabilité", "approvisionnement national"],
	...
	"AP": ["aéroporté", "analyse de professions", "ammunition point", "adjoint particulier", "affaires publiques"],
	"relq": ["relinquish"],
	...
	"O Hébgt": ["officier de l'hébergement"],
	...
	"dest": ["destinataire"],
	"ADEX": ["air defence exercise", "exercice de défense aérienne"],
	...
	"MDA": ["mine dispersable par artillerie"],
	"conslr": ["conseiller"],
	"AOD": ["absent on duty"],
	...
	"MAN": ["missile antinavire"],
	"éval": ["évaluation", "évaluer"],
	"OSC": ["officier des services comptables", "officier supérieur canadien"],
	...
	"OTM": ["officier technicien des munitions"],
	...
	"aut": ["autorité", "autorisation", "autoriser"],
	"aux": ["auxiliaire"],
	"VA": ["véhicule aérien"],
	...
	"CL": ["centre line"],
	"APR": ["air-portable raft", "adapté pour radio"],
	...
	"PIR": ["priority intelligence requirements", "protection individuelle rapprochée"],
	...
	"PD": ["premier dirigeant", "poste de détection", "piste démontable"],
	...
	"BR": ["brouillage rapproché", "bureau de recrutement"],
	"CIOR": ["Confédération interalliée des officiers de réserve"],
	"PI": ["panneau d’identification", "propriété intellectuelle"],
	...
	"CM": ["contre-mesure", "Membre de l’Ordre du Canada", "crisis management", "conseiller militaire", "Comité militaire", "cruise missile", "contrôle des mouvements", "couloir de mobilité", "classement militaire"],
	...
	"Z COMM": ["zone des communications"],
	"supt clk": ["superintendent clerk"],
	"contr": ["contrôleur"],
	...
	"O Contrat": ["officier des contrats"],
	"B Compt": ["base comptroller"],
	"instr coord": ["instruction de coordination"],
	...
	"SMC": ["sergent-major de compagnie", "système de manutention de charge"],
	...
	"DDR": ["disarmament, demobilisation and reintegration", "désarmement, démobilisation et réintégration"],
	...
	"TD": ["tir défensif"],
	"FD": ["force development", "force de débarquement"],
	...
	"ASM": ["agent de sécurité ministériel", "air-to-surface missile"],
	...
	"AMS": ["air maintenance squadron", "application management services"],
	"empl": ["emplane"],
	...
	"PPE": ["prepositioned equipment", "Plan pluriannuel des effectifs"],
	"éqpt": ["équipement"],
	...
	"exploi": ["exploitation"],
	"C de T": ["champ de tir"],
	"artil C": ["artillerie de campagne"],
	...
	"FLIP": ["publication d’information de vol"],
	...
	"RS": ["egion de suivi", "rayon de sécurité"],
	"fus": ["fusilier"],
	...
	"OGI": ["objectif de grande importance"],
	"L": ["lourd"],
	"mor L": ["mortier lourd"],
	"c-à-d": ["c’est-à-dire"],
	"AI": ["action immédiate"],
	...
	"EMI": ["état-major militaire international", "État-major militaire international", "état-major interarmées", "Escadron de egiont interarmées"],
	...
	"PO": ["point d’orientation (air)", "poste d’observation"],
	"PMO": ["plan de mise en œuvre"],
	"CPR": ["catégorie de prime de rendement", "certificat provisoire de réforme", "Cadre de la Première réserve"],
	...
	"O Maint": ["officier de la maintenance"],
	...
	"MARISAT": ["système maritime de communications par satellite", "maritime satellite communication system"],
	...
	"mit": ["mitrailleuse", "mitraillette"],
	"PM": ["pont moyen", "police militaire"],
	"mgén": ["major-général"],
	"gest": ["gestionnaire", "gestion"],
	...
	"DMS": ["distance minimale de sécurité", "document management system"],
	...
	"NLR": ["représentant national de liaison", "national liaison representative"],
	...
	"DON": ["egiontion d’observation nocturne"],
	...
	"OC": ["Officier de l’Ordre du Canada", "ordre courant"],
	...
	"stocks op": ["stocks opérationnels"],
	...
	"CAP": ["Centre egimentsive – Patients"],
	"DAP": ["défense aérienne passive"],
	"OCS": ["officier comptable de la solde", "officier contrôleur du système"],
	"OAP": ["officier des affaires publiques"],
	"PAR": ["radar d’approche de précision"],
	"para": ["parachute", "parachutiste", "parachutist", "paragraphe"],
	...
	"pd": ["période"],
	"PP": ["perfectionnement professionnel", "produits pétroliers", "petroleum point"],
	...
	"dot pers": ["dotation en personnel"],
	...
	"pharm": ["pharmaceutique", "pharmaceutical"],
	"photo": ["photographier"],
	...
	"G Prév": ["grand prévot"],
	"DF&E": ["dependents, furniture and effects"],
	"EDS": [" Executive Deployable Suite"],
	...
	"DIDP": ["Demandes de code d’identification de dossier personnel"],
	...
	"ARC": ["Artillerie royale canadienne", "Aviation royale canadienne"],
	...
	"reco": ["reconnaissance"],
	"O Recrut": ["officier de recrutement"],
	...
	"régt": ["régiment"],
	"O Réinstal": ["officier de réinstallation"],
	...
	"RO": ["rayon de l’objectif"],
	"CTSE": ["champs de tir et secteurs d’entraînement"],
	"itin": ["itinéraire"],
	"rtn": ["retourner"],
	"OMF": ["officier du ourier ferroviaire"],
	...
	"NAS": ["niveaux d’alerte en matière de sécurité", "numéro d’assurance sociale"],
	"récup": ["récupérer"],
	"MSA": ["missile sol-air", "missile surface-air"],
	"san": ["sanitaire"],
	"STANO": ["surveillance, target acquisition and night observation", "surveillance, acquisition d’objectifs et observation nocturne"],
	...
	"sig": ["signaleur"],
	"O Trans": ["officier des transmissions"],
	...
	"OEM Comm": ["officier d’état-major – communications"],
	...
	"OEM Instr": ["officier d’état-major – instruction"],
	...
	"spéc": ["spécial", "spécialiste", "spécification", "spécialité"],
	...
	"sap": ["sapeur"],
	"DC": ["domicile choisi", "division de chars"],
	"VS": ["véhicule spécialisé"],
	"QS": ["qualification du soldat"],
	...
	"tg": ["télégramme", "télégraphe", "télégraphie"],
	...
	"O Instr": ["officier de l’instruction"],
	"trig": ["trigonométrie"],
	"tn": ["transportation"],
	...
	"UXO": ["unexploded explosive ordnance", "munition explosive non explosée"],
